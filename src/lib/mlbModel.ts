...
const STARTER_SEEDS: StarterSeed[] = [
  ...
  ['ATL', 'ATL-2', 'Spencer Schwellenbach', 'R', 3.91, 3.82, 1.23, 25.2, 7.4, 0.97, 5.8, 103, 'Mid-Rotation', 88, 5],
  ['ATL', 'ATL-3', 'Reynaldo Lopez', 'R', 4.09, 3.98, 1.27, 24.5, 8.0, 1.03, 5.5, 100, 'Back-End', 85, 4],
  ...
  ['NYY', 'NYY-2', 'Max Fried', 'L', 3.58, 3.52, 1.16, 25.1, 6.9, 0.88, 6.1, 108, 'Mid-Rotation', 91, 5],
  ['NYY', 'NYY-3', 'Carlos Rodon', 'L', 3.82, 3.74, 1.2, 27.9, 7.9, 0.95, 5.8, 104, 'Back-End', 89, 4],
